...
# 获取当前脚本所在目录的绝对路径
current_dir = os.path.dirname(os.path.abspath('/content/drive/MyDrive/Colab Notebooks/sign_language/4_optimization/Diffusion_LM/improved-diffusion'))

# 添加 'improved_diffusion' 目录到 sys.path
sys.path.append(os.path.join(current_dir, '/content/drive/MyDrive/Colab Notebooks/sign_language/4_optimization/Diffusion_LM/improved-diffusion/'))
